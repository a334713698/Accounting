...
@interface HDJRecordScrollerView()<UIScrollViewDelegate>

@end

@implementation HDJRecordScrollerView
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSKeyValueChangeKey,id> *)change context:(void *)context{
    ...
    if (oldValue != newValue && [self.recordScrollerViewPageDelegate respondsToSelector:@selector(recordScrollerView:currentPage:)]) {
        [self.recordScrollerViewPageDelegate recordScrollerView:self currentPage:newValue];
    }
}
